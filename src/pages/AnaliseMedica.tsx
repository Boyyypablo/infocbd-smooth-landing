          ...
          <div className="text-center space-y-6 w-full">
            ...
            <div className="space-y-5">
              {textLines.map((line, index) => (
                <p
                  key={index}
                  className={`text-lg md:text-xl text-white font-medium leading-relaxed transition-all duration-500 ${
            ...
            >
              <Button
                ...
                className="w-full max-w-md bg-white text-[#6B2C91] px-8 py-6 rounded-lg font-semibold text-lg hover:bg-white/90 transition-all shadow-lg hover:shadow-xl hover:scale-105"
              >
